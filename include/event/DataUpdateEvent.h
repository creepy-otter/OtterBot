...
public:
    DataUpdateEvent(const std::string& symbol, double price, int volume, date::sys_seconds timestamp)
        : Event(EventType::DataUpdate), symbol_(symbol), price_(price), volume_(volume),
